...
public class Vehicle {
    ...
    static Vehicle passByValue(int i, Vehicle v) {
        ...
        System.out.println("v.passenger=vehicle.passengers=" + v.passengers + "v.mpg=vehicle.mpg=" + v.mpg
                + " v.fuelcap=vehicle.fuelcap=" + v.fuelcap);
        return vehicle;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "after assign object reference minivan to v, v reference the samememory block as minivan reference to");
